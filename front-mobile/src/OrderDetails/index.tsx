...
function OrderDetails( {route}: Props) {
  ...
  // interação com Google Maps service  - através de deep link
  // link que inicializa outros aplicativos
  //
  ...
  return (
    <>
        ...
        <View style={styles.container}>
            ...
            <RectButton style={styles.button} onPress={handleStartGoogleNavigation}>
